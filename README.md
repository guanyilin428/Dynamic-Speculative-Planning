...
python openagi_dyn.py --pred --target_type target_type --approx_type approx_type --offset offset --tau tau --model_type model_type
```
...
Then put the threes python files under travelplanner_supplement and predictor.py and util.py under Dynamic-Speculative-Planning in downloaded TravelPlanner's code under the directory TravelPlanner. 
