...
def train_model(train_dataloader, val_dataloader, gamma, lambda_, model, tokenizer, writer, lr):
    ...
    # logging.info(f"Training finished after {num_epochs} epochs")
...
if __name__ == "__main__":
    ...
    writer = SummaryWriter(log_dir=f'3_18_log/dyn_bs_lambda_{lambda_}_{ds_type}/lr_{lr}/bs_{batch_size}')
